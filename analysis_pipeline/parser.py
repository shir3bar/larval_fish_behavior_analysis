...
def get_parser():
    ...
    parser.add_argument('-fish_to_sample',type=int, default=np.inf, help='how many clips from the positive class to fish before stopping video analysis')
    ...
    parser.add_argument('-video_list_path',type=str, default='', help='path to a csv with video file names to analyze (a subset from the video data folder)')
    parser.add_argument('-cfg_path',type=str, default='./models/SLOWFAST_8x8_R50_feed_pretrained.yaml', help='Path to action classifier cfg.yaml')
